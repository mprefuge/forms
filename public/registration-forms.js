window.REGISTRATION_FORMS = {
  ...
  aliases: {
    ...
    'farmdale-esl': 'Fall 2026 - Farmdale ESL Network Registration',
    'farmdale esl network registration': 'Fall 2026 - Farmdale ESL Network Registration',
    'esl-immigrant': 'ESL Immigrant Form',
    immigrant: 'ESL Immigrant Form',
    'esl immigrant form': 'ESL Immigrant Form',
  ...
  forms: {
    ...
    'ESL Immigrant Form': 'registration-configs/esl-immigrant.js',
    'Fall 2026 - Farmdale ESL Network Registration': 'registration-configs/esl-network-registration-farmdale.js',
