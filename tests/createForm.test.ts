    ...
    it('should fail the submission when campaign resolution fails for a registration campaign', async () => {
      ...
      mockRequest = {
        ...
        json: jest.fn().mockResolvedValue({
          ...
          LastName__c: 'Lopez',
          Email: 'ana@example.com',
          __campaignName: 'Fall 2026 - Farmdale ESL Network Registration',
          __formConfig: testFormConfig,
        }),
      };
      ...
      expect(body.error).toContain('Unable to resolve Campaign for "Fall 2026 - Farmdale ESL Network Registration"');
